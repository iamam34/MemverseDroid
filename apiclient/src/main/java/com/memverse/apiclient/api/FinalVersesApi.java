...
public class FinalVersesApi extends BaseApi {
    ...
    /**
     * Build call for showFinalVerses
     *
    ...
    private com.squareup.okhttp.Call showFinalVersesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/final_verses";
    ...
    private com.squareup.okhttp.Call showFinalVersesValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {


        com.squareup.okhttp.Call call = showFinalVersesCall(progressListener, progressRequestListener);
        return call;
